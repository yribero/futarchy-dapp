...
test('Redeem when no txs happened', async t => {
    ...
    console.log('REDEEM PAYOUTS A', await redeemSeatA?.getPayouts());
    console.log('REDEEM PAYOUTS B', await redeemSeatB?.getPayouts());

    console.log('REDEEM Price A', await issuers.Price.getAmountOf(await redeemSeatA?.getPayout('Price')));
    console.log('REDEEM Price B', await issuers.Price.getAmountOf(await redeemSeatB?.getPayout('Price')));
